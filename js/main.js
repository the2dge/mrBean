...
var clickMenu = function() {
    ...
    $(document).on('click', '.fh5co-main-nav a:not([class="external"]), #fh5co-offcanvas a:not([class="external"])', function(event){
        ...
        // Log for debugging
        console.log("Menu item clicked, hiding offcanvas menu");

        // Close off-canvas menu when a link is clicked
